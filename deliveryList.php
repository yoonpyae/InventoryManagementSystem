...
if (isset($_POST['btnUpdate'])) {
  $editdeliveryID = $_POST['editdeliveryID'];
  ...
  $Update = "
      ...
      WHERE DeliveryID='$editdeliveryID'
  ";

  $ret = mysqli_query($connection, $Update);

  if ($ret) {
      echo "<script>window.alert('Delivery Updated Successfully!')</script>";
  } else {
      echo "<p>Something went wrong in updating delivery: " . mysqli_error($connection) . "</p>";
  }
}
?>
<!DOCTYPE html>
...
<?php endif; ?>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">All Deliveries</h1>
            </div>
              ...
              <div class="content">
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <div class="d-flex flex-column">
                        <nav class="navbar navbar-expand mb-4">
                          <div class="search-input">
                            <a href="deliveryList.php" class="btn btn-secondary"
                              >X</a
                            >
                            <form
                              action="deliveryList.php"
                              method="get"
                    ...
                    $conditions = [];
                    if ($searchTerm) {
                        $conditions[] = "(da.DeliveryID LIKE '%$searchTerm%' 
                                          OR e.EmployeeName LIKE '%$searchTerm%')";
                    }
                    if ($startDate) {
                        $conditions[] = "da.DeliveryDate >= '$startDate'";
                    }
                    if ($endDate) {
                        $conditions[] = "da.DeliveryDate <= '$endDate'";
                    }
                    if ($status) {
                        $conditions[] = "da.Status = '$status'";
                    }
                            ...
                            <table class="table datanew">
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < $size; $i++) { 
                                        ...
                                        echo "<td>
                                            <a class='me-3' href='deliveryDetail.php?DeliveryID=$DeliveryID'>
                                                <img src='img/eye.svg' alt='img' />
                                            </a>
                                           <a class='me-3 edit-delivery-btn' href='#' 
                                          data-id='" . $DeliveryID . "'                                               
                                          ...
                                          <img src='img/edit.svg' alt='edit icon' />
                                            ...
                                            if ($position == 'Super Admin') {
                                                echo "<a class='me-3' href='deleteDelivery.php?DeliveryID=$DeliveryID'>
                                ...
                                <div class="row">
                                  <div class="col-md-6">                                   
                                    <div class="form-group mb-3">
                                      ...
                                      <option value="InProgress" <?php echo ($arr['Status'] == 'Send') ? 'selected' : ''; ?>>Send</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
    ...
    <script src="js/editDelivery.js"></script>
