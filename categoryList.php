...
if (isset($_POST['btnSave'])) {
  ...
  $checkCategory = "SELECT * FROM category WHERE CategoryName='$txtCategory'";
  $ret = mysqli_query($connection, $checkCategory);
  ...
  if ($size > 0) { 
    ...
    $Insert = "INSERT INTO `category` (CategoryName) VALUES('$txtCategory')"; 
...
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - All Categories</title>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      ...
                      if($searchTerm) {
                        $query = "SELECT * FROM category WHERE CategoryID LIKE '%$searchTerm%' OR CategoryName LIKE '%$searchTerm%'";
                      } else {
                          $query = "SELECT * FROM category"; // Show all records if no search term
                      }
                      ...
                      <table class="table datanew">
                        ...
                        { 
                          ...
                          echo "<tr>";
                            ...
                            echo "<td>
                            <a class='me-3 edit-category-btn' href='#' 
                               data-id='" . $arr['CategoryID'] . "' 
                               data-name='" . $arr['CategoryName'] . "'>
                              <img src='img/edit.svg' alt='edit icon' />
                            </a>

                            <a class='me-3 delete-btn' href='deleteCategory.php?CategoryID=$CategoryID' >
