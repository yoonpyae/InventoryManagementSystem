...
if(isset($_POST['btnSave'])) 
{
	...
	$checkProduct="SELECT * FROM product 
				 WHERE ProductName='$txtProductName' ";
	...
	{ 
		$Insert="INSERT INTO `product`
				(`ProductName`, `CategoryID`, `StockAlert`, `Quantity`, `ProductCost`, `ProductPrice`) 
				VALUES
				('$txtProductName','$cboCategoryID','$txtStockAlert','$txtQuantity','$txtProductCost','$txtProductPrice')";
...
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - Create Product</title>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="page-wrapper">
              <form action="createProduct.php" method="POST"></form>
                <div class="content">
                              ...
                              <div class="row g-3">
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="txtProductName" name="txtProductName" placeholder="Enter product name" required />
                                      </div>
                                  </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="form-group">
                                          <label for="txtStockAlert" class="form-label">Stock Alert</label>
                                          <input type="text" class="form-control" id="txtStockAlert" name="txtStockAlert" placeholder="Enter stock alert" required />
                                      </div>
                                  </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="form-group">
                                          <label for="txtQuantity" class="form-label">Quantity</label>
                                          <input type="text" class="form-control" id="txtQuantity" name="txtQuantity" placeholder="Enter quantity" required />
                                      </div>
                                  </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="form-group">
                                          <label for="txtProductCost" class="form-label">Product Cost (MMK)</label>
                                          <input type="text" class="form-control" id="txtProductCost" name="txtProductCost" placeholder="Enter product cost" required />
                                      </div>
                                  </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                      <div class="form-group">
                                          <label for="txtProductPrice" class="form-label">Product Price (MMK)</label>
                                          <input type="text" class="form-control" id="txtProductPrice" name="txtProductPrice" placeholder="Enter product price" required />
                                      </div>
                                  </div>
                                  <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                      <label for="cboCategoryID" class="form-label">Category</label>
                                      <select class="form-control" id="cboCategoryID" name="cboCategoryID" required>
