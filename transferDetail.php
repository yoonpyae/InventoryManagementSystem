...
//Single-------------------------------
$Query1="SELECT ta.*, e.Position,e.EmployeeName,w1.WarehouseName AS FromWarehouseName, w2.WarehouseName AS ToWarehouseName,w1.Location AS FromWarehouseLocation, w2.Location AS ToWarehouseLocation
...
//Repete-------------------------------
$Query2="SELECT ta.*, tad.*, pro.ProductCost,pro.ProductName
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">Transfer Detail</h1>
            </div>
            <div class="page-wrapper">
              <div class="content">
                <div class="page-header">
                  <div class="page-title">
                    <h6>Manage your transfer detail</h6>
                  </div>
                </div>

                <form action="transferDetail.php" method="post">
                  <div class="card">
                    <div class="card-body">
                      <div class="mb-5">
                        <!-- Top Buttons -->
                        ...
                        <button class="btn btn-outline-secondary me-2 mr-2">
                         <a href="transferList.php" class="text-decoration-none"><i class="fas fa-arrow-left"></i> All Transfers</a> 
                          </button>
                          <?php echo "<a class='btn btn-purple me-2 mr-2' style='background-color: #9b59b6; color: white' href='transferDetail_pdf.php?TransferID=" . $arr1['TransferID'] . "'><i class='fas fa-file-pdf'></i> PDF</a>"; ?>                             
                        </div>
                        <!-- Transfer Details Header -->
                        <div class="text-center mt-5 mb-5">
                          <h3>Transfer Detail : <?php echo $arr1['TransferID'] ?></h3>
                        </div>

                        <!-- Info Sections -->
                        <div class="row info-section">
                          <div class="col-md-3">
                            <h5><strong>From Warehosue Info</strong></h5>
                            <p>
                            <?php echo $arr1['FromWarehouseName'] ?><br />
                            <?php echo $arr1['FromWarehouseLocation'] ?><br />
                            </p>
                          </div>
                          <div class="col-md-3">
                            <h5><strong>To Warehosue Info</strong></h5>
                            <p>
                            <?php echo $arr1['ToWarehouseName'] ?><br />
                            <?php echo $arr1['ToWarehouseLocation'] ?><br />
                            </p>
                          </div>
                          <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            <h5><strong>Transfer Info</strong></h5>
                            <p>
                              Reference: <?php echo $arr1['TransferID'] ?><br />
                              Status:
                        ...
                        <!-- Order Summary Table -->
                        <h5 class="mb-3"><strong>Transfer Summary</strong></h5>
                        <table class="table table-bordered order-summary">
                          ...
                          { 
                            ...
                            echo "<tr>";
                              echo "<td>" . $arr2['ProductName'] . "</td>";
                              echo "<td>" . $arr2['Price'] . "</td>";
                              echo "<td>" . $arr2['Quantity'] . "</td>";
                              echo "<td>" . $arr2['Quantity'] * $arr2['Price'] . "</td>";
                            echo "</tr>";
                          }
                          ?>
                          </tbody>
