...
if (isset($_POST['btnSave'])) {
  // Check if saleID are added to the session
  if (!isset($_SESSION['Delivery_Functions']) || count($_SESSION['Delivery_Functions']) === 0) {
      echo "<script>
              alert('Error: No SaleID added to the delivery. Please add at least one SaleID before saving.');
              window.location='createDelivery.php';
            </script>";
      exit();
  }
    $txtDeliveryID = $_POST['txtDeliveryID'];
    $txtDeliveryDate = $_POST['txtDeliveryDate'];
    $EmployeeID = $_POST['cboEmployeeID'];
    ...
    $checkQuery = "SELECT * FROM delivery WHERE DeliveryID = '$txtDeliveryID'";
    $checkResult = mysqli_query($connection, $checkQuery);

    if(mysqli_num_rows($checkResult) > 0) {
        echo "<script>window.alert('Error: Duplicate DeliveryID.')</script>";
    } else {
        $Insert1 = "INSERT INTO `delivery`
                  (`DeliveryID`,`DeliveryDate`, `EmployeeID`, `TotalQuantity`, `TotalAmount`, `Status`, `Note`) 
                  VALUES
                  ('$txtDeliveryID','$txtDeliveryDate','$EmployeeID','$txtTotalQuantity','$txtTotalAmount','$cboStatus','$txtNote')";
        ...
        if($ret1) {
            ...
            for ($b = 0; $b < $size; $b++) { 
                $SaleID = $_SESSION['Delivery_Functions'][$b]['SaleID'];
                $DeliveryQuantity = $_SESSION['Delivery_Functions'][$b]['DeliveryQuantity'];
                $DeliveryPrice = $_SESSION['Delivery_Functions'][$b]['DeliveryPrice'];

                $Insert2 = "INSERT INTO `deliverydetail`
                          (`DeliveryID`, `SaleID`, `Quantity`,`DeliveryFee`) 
                          VALUES
                          ('$txtDeliveryID', '$SaleID', '$DeliveryQuantity','$DeliveryPrice')";
            ...
            if($ret2) {
                ...
                echo "<p>Something went wrong in deliverydetail insert: " . mysqli_error($connection) . "</p>";
            }
        } else {
...
{
	$SaleID=$_POST['cboSaleID'];
	$DeliveryQuantity=$_POST['txtQuantity'];
  $DeliveryPrice=$_POST['txtDeliveryFee'];

  AddSale($SaleID,$DeliveryPrice,$DeliveryQuantity);
}
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">Add Delivery</h1>
            </div>

            <!-- Content Row -->
            <div class="page-wrapper">
              <form method="POST" action="createDelivery.php">
                <div class="content">
                  <div class="page-header">
                    <div class="page-title">
                      <h6>Add New Delivery</h6>
                    </div>
                  </div>
                  <div class="card">
                    <div class="card-body">
                      <div class="row mb-4">
                         ...
                         <div class="col-lg-3 col-sm-6 col-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              id="txtDeliveryID"
                              name="txtDeliveryID"
                              value="<?php echo AutoID('delivery','DeliveryID','D-',4) ?>"
                              readonly
                            />
                          </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                              <label>SaleID</label>
                              <select class="form-control" name="cboSaleID">
                                <option selected disabled>Choose Sale</option>
                                <?php
                                ...
                                for ($i = 0; $i < $count; $i++) {
                                  $arr = mysqli_fetch_array($ret);
                                  $SaleID = $arr['SaleID'];
                                  echo "<option value='$SaleID'>" . $arr['SaleID'] . "</option>";
                                }
                                ?>
                              </select>
                            </div>
                          ...
                          <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="number" name="txtDeliveryFee" value="0" /> 
                            </div>
                          </div>
                          ...
                          <table class="table table-striped">
                            ...
                            <tbody>
                              ...
                              if(!isset($_SESSION['Delivery_Functions'])) 
                              {
                                ...
                                for($x=0;$x<$size;$x++) 
                                { 
                                  $SaleID=$_SESSION['Delivery_Functions'][$x]['SaleID'];
  
                                  echo "<tr>";
                                    echo "<td>"	. $_SESSION['Delivery_Functions'][$x]['SaleID'] ."</td>";
                                    echo "<td>"	. $_SESSION['Delivery_Functions'][$x]['DeliveryPrice'] ."</td>";
                                    echo "<td>"	. $_SESSION['Delivery_Functions'][$x]['DeliveryQuantity'] ."</td>";
                                    echo "<td>"	. $_SESSION['Delivery_Functions'][$x]['TotalQuantity'] ."</td>";
          
                                    echo "<td>" . $_SESSION['Delivery_Functions'][$x]['DeliveryPrice'] * 
                                                  $_SESSION['Delivery_Functions'][$x]['DeliveryQuantity']. "</td>";
                                    echo "<td><a class='delete-set' href='createDelivery.php?action=remove&SaleID=$SaleID'><img src='img/delete.svg' alt='delete'/></a></td>";
                                  echo "</tr>";
                                }
                              }
                                ?>
                        ...
                        <div class="col-lg-12 d-flex justify-content-end">
                          <div class="total-order">
                            <table class="table table-bordered table-striped">
                              <thead>
                                <tr>
                                  <th class="text-center" colspan="2">Delivery Summary</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                      ...
                      <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <select class="form-control" name="cboEmployeeID" >
                                    ...
                                    echo "<option value='$EmployeeID'>" . $arr['EmployeeName'] . "</option>";
                                    }
                                    ?>
                                    </select>                                
                                </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          <a href="createDelivery.php?action=clearall" class="btn btn-light"
                            >Cancel</a
                          >
                        </div>
                      </div>
