...
if (isset($_POST['btnUpdate'])) {
  $editTransferID = $_POST['editTransferID'];
  ...
  $Update = "
      ...
      WHERE TransferID='$editTransferID'
  ";

  $ret = mysqli_query($connection, $Update);

  if ($ret) {
      echo "<script>window.alert('Transfer Updated Successfully!')</script>";
  } else {
      echo "<p>Something went wrong in updating transfer: " . mysqli_error($connection) . "</p>";
  }
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - All Transfers</title>
  ...
  <body id="page-top">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">All Transfers</h1>
            </div>
              ...
              <div class="content">
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <div class="d-flex flex-column">
                        <nav class="navbar navbar-expand mb-4">
                          <div class="search-input">
                            <a href="transferList.php" class="btn btn-secondary"
                              >X</a
                            >
                            <form
                              action="transferList.php"
                              method="get"
                    ...
                    $query = "
                        SELECT ta.*, w1.WarehouseName AS FromWarehouseName, w2.WarehouseName AS ToWarehouseName, e.EmployeeName
                        FROM transfer ta
                    ...
                    $conditions = [];
                    if ($searchTerm) {
                        $conditions[] = "(ta.TransferID LIKE '%$searchTerm%' 
                                          OR w1.WarehouseName LIKE '%$searchTerm%' 
                                          OR w2.WarehouseName LIKE '%$searchTerm%'
                                          OR e.EmployeeName LIKE '%$searchTerm%')";
                    }
                    if ($startDate) {
                        $conditions[] = "ta.TransferDate >= '$startDate'";
                    }
                    if ($endDate) {
                        $conditions[] = "ta.TransferDate <= '$endDate'";
                    }
                    if ($status) {
                            ...
                            <table class="table datanew">
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < $size; $i++) { 
                                        ...
                                        echo "<td>" .$arr['TransferDate'] . "</td>";
                                        echo "<td>" .$arr['FromWarehouseName'] . "</td>"; // Display From Warehouse Name
                                        echo "<td>" .$arr['ToWarehouseName'] . "</td>"; // Display To Warehouse Name
                                        ...
                                        echo "<td>";
                                        echo "<a class='me-3' href='transferDetail.php?TransferID=$TransferID'>
                                                <img src='img/eye.svg' alt='img' />
                                              </a>";
                                        echo "<a class='me-3 edit-transfer-btn' href='#' 
                                                data-id='" . $TransferID . "'                                               
                                        ...
                                        if ($position == 'Super Admin') {
                                            echo "<a class='confirm-text' href='deleteTransfer.php?TransferID=$TransferID'>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="transferList.php" method="post">
                                <input type="hidden" name="editTransferID" id="editTransferID" />
                                <div class="row">
                                  <div class="col-md-6">                                   
                                    <div class="form-group mb-3">
                                      ...
                                      <option value="Send" <?php echo ($arr['Status'] == 'Send') ? 'selected' : ''; ?>>Send</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
    ...
    <script src="js/editTransfer.js"></script>
