...
if (isset($_POST['btnSave'])) {
    ...
    $checkPhoneNumber = "SELECT * FROM supplier WHERE PhoneNumber='$txtPhoneNumber'";
    $ret = mysqli_query($connection, $checkPhoneNumber);
    ...
    if ($size > 0) {
        ...
        $Insert = "INSERT INTO `supplier`
            (`SupplierName`,`ContactPerson`, `PhoneNumber`, `Address`) 
            VALUES
            ('$txtSupplierName','$txtContactPerson','$txtPhoneNumber','$txtAddress')";
...
if (isset($_POST['btnUpdate'])) {
    ...
    $editContactPerson = $_POST['editContactPerson'];
    $editPhoneNumber = $_POST['editPhoneNumber'];
    $editAddress = $_POST['editAddress'];

    // Update query
    $Update = "UPDATE supplier 
               SET SupplierName='$editSupplierName',
                   ContactPerson='$editContactPerson',
                   Address='$editAddress', 
                   PhoneNumber='$editPhoneNumber'
               WHERE SupplierID='$editSupplierID'";
...
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - Supplier</title>
  ...
  <body id="page-top">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php  
                      ...
                      if($searchTerm) {
                        $query = "SELECT * FROM supplier WHERE SupplierID LIKE '%$searchTerm%' OR SupplierName LIKE '%$searchTerm%'";
                      } else {
                          $query = "SELECT * FROM supplier"; // Show all records if no search term
                      }
                      ...
                      <table class="table datanew">
                        ...
                        <?php  
                            for($i=0;$i<$size;$i++) { 
                                ...
                                echo "<td>" . $arr['ContactPerson'] . "</td>";
                                echo "<td>" . $arr['Address'] . "</td>";
                                echo "<td>" . $arr['PhoneNumber'] . "</td>";
                                echo "<td>
                                      <a class='me-3 edit-supplier-btn' href='#' 
                                        data-id='" . $arr['SupplierID'] . "' 
                                        data-name='" . $arr['SupplierName'] . "' 
                                        data-person='" . $arr['ContactPerson'] . "' 
                              ...
                              if ($position == 'Super Admin') {
                                  echo "<a class='me-3 delete-btn' href='deleteSupplier.php?SupplierID=$SupplierID' >
    ...
    <script src="js/editSupplier.js"></script>
