...
if (isset($_POST['btnUpdate'])) {
  $editpurchaseID = $_POST['editpurchaseID'];
  ...
  $Update = "
      ...
      WHERE PurchaseID='$editpurchaseID'
  ";

  $ret = mysqli_query($connection, $Update);

  if ($ret) {
      echo "<script>window.alert('Purchase Updated Successfully!')</script>";
  } else {
      echo "<p>Something went wrong in updating purchase: " . mysqli_error($connection) . "</p>";
  }
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">All Purchases</h1>
            </div>
              ...
              <div class="content">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-top">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <div class="search-input">
                          <a href="purchaseList.php" class="btn btn-secondary ">X</a>
                          <form action="purchaseList.php" method="get" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                              <div class="input-group ">
                                <input
                                  type="text"
                                  name="search"
                                ...
                                <div class="input-group mr-1">
                                  <label for="start_date" class="form-label me-2">From:</label>
                                  <input
                                    type="date"
                                    id="start_date"
                                    name="start_date"
                                ...
                                <div class="input-group ">
                                  <label for="end_date" class="form-label me-2">To:</label>
                                  <input
                                    type="date"
                                    id="end_date"
                                    name="end_date"
                    ...
                    $query = "
                        SELECT pu.*, s.SupplierName, w.WarehouseName, e.EmployeeName
                        FROM purchase pu
                        INNER JOIN supplier s ON pu.SupplierID = s.SupplierID
                        INNER JOIN warehouse w ON pu.WarehouseID = w.WarehouseID
                        INNER JOIN employee e ON pu.EmployeeID = e.EmployeeID
                    ";

                    // Modify query if there is a search term
                    $conditions = [];
                    if ($searchTerm) {
                        $conditions[] = "(pu.PurchaseID LIKE '%$searchTerm%' 
                                          OR s.SupplierName LIKE '%$searchTerm%' 
                                          OR w.WarehouseName LIKE '%$searchTerm%'
                                          OR e.EmployeeName LIKE '%$searchTerm%')";
                    }
                    if ($startDate) {
                        $conditions[] = "pu.PurchaseDate >= '$startDate'";
                    }
                    if ($endDate) {
                        $conditions[] = "pu.PurchaseDate <= '$endDate'";
                    }
                    if ($status) {
                        $conditions[] = "pu.Status = '$status'";
                    }
                    ...
                    <div class="table-responsive">
                      <table class="table datanew">
                        ...
                        <?php  
                            ...
                            echo "<td>
                            <a class='me-3' href='purchaseDetail.php?PurchaseID=$PurchaseID'>
                                <img src='img/eye.svg' alt='img' />
                            </a>
                            <a class='me-3 edit-purchase-btn' href='#' 
                                data-id='" . $PurchaseID . "' 
                    ...
                    if ($position == 'Super Admin') {
                        echo "<a class='confirm-text' href='deletePurchase.php?PurchaseID=$PurchaseID'>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="purchaseList.php" method="post">
                                <input type="hidden" name="editpurchaseID" id="editpurchaseID" />
                                <div class="row">
                                  <div class="col-md-6">                                   
                                    <div class="form-group mb-3">
                                      ...
                                      <option value="Received" <?php echo ($arr['Status'] == 'Received') ? 'selected' : ''; ?>>Received</option>
                                      <option value="Ordered" <?php echo ($arr['Status'] == 'Ordered') ? 'selected' : ''; ?>>Ordered</option>
    ...
    <script src="js/editPurchase.js"></script>
