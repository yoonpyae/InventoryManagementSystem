...
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - Purchase Report</title>
                  ...
                  <div class="card-body">
                    <div class="table-top">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <a href="purchaseReport.php" class="btn btn-secondary ">X</a>
                          <form action="purchaseReport.php" method="get" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                              <div class="input-group ">
                                <input
                                  type="text"
                                  name="search"
          ...
          <table class="table datanew">
            ...
            <?php  
                for ($i = 0; $i < $size; $i++) { 
                    ...
                    // Accumulate totals
                    $totalGrandTotal += $arr['GrandTotal'];
                    ...
                    echo "<td>" .number_format($arr['GrandTotal'], 2) . "</td>";
                    echo "<td>" .number_format($arr['TotalQuantity'], 2) . "</td>";     
                    echo "</tr>";
                }
                ?>
            </tbody>
