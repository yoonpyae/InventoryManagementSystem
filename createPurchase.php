...
{
  echo "<script>window.alert('Please log in to access the staff home page.')</script>";
...
if (isset($_POST['btnSave'])) {
 ...
 if (!isset($_SESSION['Purchase_Functions']) || count($_SESSION['Purchase_Functions']) === 0) {
  echo "<script>
          alert('Error: No products added to the purchase. Please add at least one product before saving.');
          window.location='createPurchase.php';
        </script>";
  exit(); // Ensure script execution stops
    ...
    $cboWarehouseID = $_POST['cboWarehouse'];
    $cboStatus = $_POST['cboStatus'];

    // Check if PurchaseID already exists
    $checkQuery = "SELECT * FROM purchase WHERE PurchaseID = '$txtPurchaseID'";
    $checkResult = mysqli_query($connection, $checkQuery);

    if(mysqli_num_rows($checkResult) > 0) {
        echo "<script>window.alert('Error: Duplicate PurchaseID.')</script>";
    } else {
        $Insert1 = "INSERT INTO `purchase`
                  (`PurchaseID`, `PurchaseDate`, `SupplierID`, `EmployeeID`, `TotalQuantity`, `TotalAmount`, `VAT`, `GrandTotal`, `Status`, `Description`, `WarehouseID`) 
                  VALUES
                  ('$txtPurchaseID','$txtPurchaseDate','$cboSupplierID','$EmployeeID','$txtTotalQuantity','$txtTotalAmount','$txtVAT','$txtGrandTotal','$cboStatus','$txtDescription','$cboWarehouseID')";
        ...
        if($ret1) {
            ...
            for ($b = 0; $b < $size; $b++) { 
                $ProductID = $_SESSION['Purchase_Functions'][$b]['ProductID'];
                $PurchaseQuantity = $_SESSION['Purchase_Functions'][$b]['PurchaseQuantity'];

                $Insert2 = "INSERT INTO `purchasedetail`
                          (`PurchaseID`, `ProductID`, `Quantity`) 
                          VALUES
                          ('$txtPurchaseID', '$ProductID', '$PurchaseQuantity')";
            ...
            if($ret2) {
                ...
                echo "<p>Something went wrong in purchasedetail insert: " . mysqli_error($connection) . "</p>";
            }
        } else {
...
if(isset($_POST['btnAdd'])) 
{
	...
	AddProduct($ProductID, $PurchaseQuantity);
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - Create Purchase</title>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="page-wrapper">
             <form method="POST" action="createPurchase.php">
                <div class="content">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              class="form-control"
                              id="txtPurchaseID"
                              name="txtPurchaseID" value="<?php echo AutoID('purchase','PurchaseID','P-',6) ?>" readonly
                            />
                          </div>
                        </div>
                          ...
                          <table class="table table-striped">
                            ...
                            if(!isset($_SESSION['Purchase_Functions'])) 
                            {
                              ...
                              { 
                                ...
                                echo "<tr>";
                                  echo "<td>"	. $_SESSION['Purchase_Functions'][$x]['ProductName'] ."</td>";
                                  echo "<td>"	. $_SESSION['Purchase_Functions'][$x]['PurchaseQuantity'] ."</td>";
                                  echo "<td>"	. $_SESSION['Purchase_Functions'][$x]['ProductCost'] ."</td>";
                                  echo "<td>" . $_SESSION['Purchase_Functions'][$x]['ProductCost'] * 
                                                $_SESSION['Purchase_Functions'][$x]['PurchaseQuantity']. "</td>";
                                  echo "<td><a class='delete-set' href='createPurchase.php?action=remove&ProductID=$ProductID'><img src='img/delete.svg' alt='delete'/></a></td>";
                                echo "</tr>";
                              }
                            }
                              ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                          <div class="form-group">
                            ...
                            <div class="d-flex">
                            <select class="form-control" name="cboSupplier" >
                            <option value="" selected disabled>Choose Supplier</option>
                                ...
                                echo "<option value='$SupplierID'>" . $arr['SupplierName'] . "</option>";
                                }
                                ?>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                          <div class="form-group">
                              ...
                              <div class="d-flex">
                                  <select class="form-control" name="cboWarehouse" >
                                      <option value="" selected disabled>Choose Warehouse</option>
                                      <?php
                                      // Only select warehouses where Status is 'Active'
                        ...
                        <div class="col-lg-12">
                          ...
                          <a href="createPurchase.php?action=clearall" class="btn btn-light"
                            >Cancel</a
                          >
                        </div>
                      </div>
