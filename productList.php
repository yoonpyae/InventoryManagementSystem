...
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - All Products</title>
              ...
              <div class="content">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-top">
                      ...
                      <div class="d-flex flex-column">
                        <nav class="navbar navbar-expand mb-4">
                          ...
                          <a href="productList.php" class="btn btn-secondary ">X</a>
                          <form action="productList.php" method="get" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                              <div class="input-group">
                                <input
                                  type="text"
                                  name="search"
                    ...
                    if ($searchTerm) {
                        $query .= " WHERE p.ProductID LIKE '%$searchTerm%' OR p.ProductName LIKE '%$searchTerm%'";
                    }
                    ...
                    <div class="table-responsive">
                        <table class="table datanew">
                            ...
                            for ($i = 0; $i < $size; $i++) { 
                                ...
                                echo "<td><span class='badge rounded-pill text-warning border border-warning'>" .$arr['StockAlert'] . "</span></td>";
                                echo "<td>" . $arr['Quantity'] . "</td>";
                                echo "<td>" . $arr['ProductCost'] . "</td>";
                                echo "<td>" . $arr['ProductPrice'] . "</td>";
                                echo "<td>
            <a class='me-3' href='editproduct.php?ProductID=$ProductID'>
                <img src='img/edit.svg' alt='img' />
            </a>";
    
    // Show delete option only for Super Admin
    if ($position == 'Super Admin') {
        echo "<a class='confirm-text' href='deleteproduct.php?ProductID=$ProductID'>
