...
if (isset($_POST['btnSave'])) {
    ...
    $checkPhoneNumber = "SELECT * FROM customer WHERE PhoneNumber='$txtPhoneNumber'";
    ...
    if ($size > 0) {
        ...
        $Insert = "INSERT INTO `customer`
            ...
            VALUES
            ('$txtCustomerName','$txtAddress', '$txtPhoneNumber')";
...
if (isset($_POST['btnUpdate'])) {
    ...
    $Update = "UPDATE customer 
               SET CustomerName='$editCustomerName',
                   Address='$editAddress', 
    ...
    if ($ret) {
        echo "<script>window.alert('Customer Updated Successfully!')</script>";
        echo "<script>window.location='customer.php'</script>";
    } else {
...
<html lang="en">
  <head>
    ...
    <title>Aung Bi Win Rice Trading House - Customer</title>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      ...
                      if($searchTerm) {
                        $query = "SELECT * FROM customer WHERE CustomerID LIKE '%$searchTerm%' OR CustomerName LIKE '%$searchTerm%'";
                      } else {
                          $query = "SELECT * FROM customer"; // Show all records if no search term
                      }
                      ...
                      <table class="table datanew">
                        ...
                        <tbody>                       
                            ...
                            for($i=0;$i<$size;$i++) { 
                                ...
                                echo "<td>
                                <a class='me-3 edit-customer-btn' href='#' 
                                   data-id='" . $arr['CustomerID'] . "' 
                                   data-name='" . $arr['CustomerName'] . "' 
                        ...
                        if ($position == 'Super Admin') {
                            echo "<a class='me-3 delete-btn' href='deleteCustomer.php?CustomerID=$CustomerID' >
