...
//Single-------------------------------
$Query1="SELECT sa.*, e.Position,e.EmployeeName,c.CustomerName,c.Address,c.PhoneNumber,w.WarehouseName
...
//Repete-------------------------------
$Query2="SELECT sa.*, sad.*, pro.ProductPrice,pro.ProductName
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">Sale Detail</h1>
            </div>
            <div class="page-wrapper">
              <div class="content">
                <div class="page-header">
                  <div class="page-title">
                    <h6>Manage your sale detail</h6>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="mb-5">
                        ...
                        <button class="btn btn-outline-secondary me-2 mr-2">
                         <a href="saleList.php" class="text-decoration-none"><i class="fas fa-arrow-left"></i> All Sales</a> 
                          </button>                          
                          <?php echo "<a class='btn btn-purple me-2 mr-2' style='background-color: #9b59b6; color: white' href='saleDetail_pdf.php?SaleID=" . $arr1['SaleID'] . "'><i class='fas fa-file-pdf'></i> PDF</a>"; ?>             

                        </div>

                        <!-- Sale Details Header -->
                        <div class="text-center mt-5 mb-5">
                          <h3>Sale Detail : <?php echo $arr1['SaleID'] ?></h3>
                        </div>
                        ...
                        <div class="row info-section">
                          ...
                          <div class="col-md-4">
                            <h5><strong>Invoice  Info</strong></h5>
                            <p>
                              Reference: <?php echo $arr1['SaleID'] ?><br />
                              Status:
                        ...
                        <table class="table table-bordered order-summary">
                          ...
                          { 
                            ...
                            echo "<tr>";
                              ...
                              echo "<td>" . $arr2['ProductPrice'] . "</td>";
                              echo "<td>" . $arr2['Quantity'] . "</td>";
                              echo "<td>" . $arr2['Quantity'] * $arr2['ProductPrice'] . "</td>";
                            echo "</tr>";
                          }
                          ?>
                          </tbody>
