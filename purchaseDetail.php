...
//Single-------------------------------
$Query1="SELECT pu.*, e.Position,e.EmployeeName,sup.ContactPerson,sup.SupplierName,sup.Address,sup.PhoneNumber,w.WarehouseName
...
//Repete-------------------------------
$Query2="SELECT pu.*, pud.*, pro.ProductCost,pro.ProductName
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">Purchase Detail</h1>
            </div>
            <div class="page-wrapper">
              <div class="content">
                <div class="page-header">
                  <div class="page-title">
                    <h6>Manage your purchase detail</h6>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="mb-5">
                        ...
                        <button class="btn btn-outline-secondary me-2 mr-2">
                         <a href="purchaseList.php" class="text-decoration-none"><i class="fas fa-arrow-left"></i> All Purchases</a> 
                          </button>
                          <?php echo "<a class='btn btn-purple me-2 mr-2' style='background-color: #9b59b6; color: white' href='purchaseDetail_pdf.php?PurchaseID=" . $arr1['PurchaseID'] . "'><i class='fas fa-file-pdf'></i> PDF</a>"; ?>
                        </div>

                        <!-- Purchase Details Header -->
                        <div class="text-center mt-5 mb-5">
                          <h3>Purchase Detail : <?php echo $arr1['PurchaseID'] ?></h3>
                        </div>
                        ...
                        <div class="row info-section">
                          <div class="col-md-4">
                            ...
                            <p>
                            <?php echo $arr1['SupplierName'] ?><br />
                            <?php echo $arr1['ContactPerson'] ?><br />
                            <?php echo $arr1['PhoneNumber'] ?><br />
                            <?php echo $arr1['Address'] ?>
                            </p>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <h5><strong>Purchase Info</strong></h5>
                            <p>
                              Reference: <?php echo $arr1['PurchaseID'] ?><br />
                              Status:
                              <span class="badge bg-success"><?php echo $arr1['Status'] ?></span><br />
                              Warehouse: <?php echo $arr1['WarehouseName'] ?><br />
                              Note:
                              <span ><?php echo $arr1['Description'] ?></span>
                            </p>
                          </div>
                        </div>
                        ...
                        <table class="table table-bordered order-summary">
                          ...
                          { 
                            ...
                            echo "<tr>";
                              ...
                              echo "<td>" . $arr2['ProductCost'] . "</td>";
                              echo "<td>" . $arr2['Quantity'] . "</td>";
                              echo "<td>" . $arr2['Quantity'] * $arr2['ProductCost'] . "</td>";
                            echo "</tr>";
                          }
                          ?>
                          </tbody>
                        ...
                        <div class="row justify-content-end">
                          <div class="col-md-4">
                            <table class="table table-borderless">
                              ...
                              <tr>
                                <th>VAT(1%):</th>
                                <td><?php echo $arr1['VAT'] ?> MMK</td>
                              </tr>
                              <tr>
                                <th>Grand Total:</th>
                                <td><strong><?php echo $arr1['GrandTotal'] ?> MMK</strong></td>
                              </tr>
                            </table>
                          </div>
                        </div>
